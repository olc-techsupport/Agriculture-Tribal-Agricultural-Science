...
- SD_TRIBES_ALL     : All 8 South Dakota Tribal Nations in scope
...
SD_TRIBES_PRIMARY = [
    ...
    "Rosebud Sioux",       # Rosebud — adjacent to Pine Ridge, similar ecology
]
...
CENSUS_NAME_MAP = {
    "Oglala Lakota":             "Pine Ridge Reservation and Off-Reservation Trust Land",
    "Rosebud Sioux":             "Rosebud Indian Reservation and Off-Reservation Trust Land",
    "Standing Rock Sioux":       "Standing Rock Reservation",
    "Cheyenne River Sioux":      "Cheyenne River Reservation and Off-Reservation Trust Land",
    "Lower Brule Sioux":         "Lower Brule Reservation and Off-Reservation Trust Land",
    "Crow Creek Sioux":          "Crow Creek Reservation",
    "Sisseton Wahpeton Oyate":   "Lake Traverse Reservation and Off-Reservation Trust Land",
    "Flandreau Santee Sioux":    "Flandreau Reservation",
}
